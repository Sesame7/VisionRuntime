...
class _TCPServer(socketserver.ThreadingTCPServer):
	...
	def __init__(self, server_address, handler_cls, *, max_bytes: int, encoding: str, max_preview: int, show_text: bool):
...
def main():
	p = argparse.ArgumentParser(description="Listen on a TCP port and print incoming payloads")
	...
	p.add_argument("--max-preview", type=int, default=256, help="Preview bytes for hex/text output (0=full)")
	p.add_argument("--encoding", default="utf-8", help="Decode bytes using this encoding")
